    ...
    <div class="user-code-content-container pt-5 px-6 pb-5 bg-emerald-100 w-full lg:w-3/4 xl:w-4/5 2xl:w-4/5">
        ...
        <div class="container w-full mx-auto px-2">
            ...
            <div class="relative text-center mt-3 lg:mt-1 h-10 lg:h-16">
                ...
                <a type="button" href="./printCodes.php?transaction=<?php echo $_GET["transaction"]?>"class="lg:absolute lg:right-0 text-white bg-[#2557D6] hover:bg-[#2557D6]/90 focus:ring-4 focus:ring-[#2557D6]/50 focus:outline-none font-medium rounded-lg text-lg px-5 py-2 text-center inline-flex items-center mr-2 mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-3">

<div id="drawer-navigation" class="hidden overflow-hidden lg:block pt-6 drop-shadow-2xl border br-2 fixed z-40 p-4 overflow-y-auto bg-white w-80 lg:w-1/4 xl:w-1/5 2xl:w-1/5 h-full" tabindex="-1" aria-labelledby="drawer-navigation-label">
  ...
  <div class="py-4 overflow-y-auto">
      <ul class="space-y-2">
         ...
         <li>
            <a href="./payout-request.php" id="payout" class="flex items-center p-2 text-base font-normal text-gray-600 rounded-lg hover:bg-emerald-600 hover:text-white">
                <svg class="flex-shrink-0 w-7 h-7" viewBox="0 0 512 512" fill="currentColor"  xmlns="http://www.w3.org/2000/svg" version="1.1" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g>
         ...
         <li>
            <a href="./transactions.php" id="transaction" class="flex items-center p-2 text-base font-normal text-gray-600 rounded-lg hover:bg-emerald-600 hover:text-white">
            <svg class="flex-shrink-0 w-7 h-7" viewBox="0 0 512 512" fill="currentColor"  xmlns="http://www.w3.org/2000/svg" version="1.1" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd" xmlns:xlink="http://www.w3.org/1999/xlink">
                <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" stroke="none">
         ...
         <li>
            <a href="./reports.php" id="reports" class="flex items-center p-2 text-base font-normal text-gray-600 rounded-lg hover:bg-emerald-600 hover:text-white">
            <svg aria-hidden="true" class="flex-shrink-0 w-7 h-7" fill="currentColor" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><!-- Font Awesome Pro 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) --><path d="M288 256H96v64h192v-64zm89-151L279.1 7c-4.5-4.5-10.6-7-17-7H256v128h128v-6.1c0-6.3-2.5-12.4-7-16.9zm-153 31V0H24C10.7 0 0 10.7 0 24v464c0 13.3 10.7 24 24 24h336c13.3 0 24-10.7 24-24V160H248c-13.2 0-24-10.8-24-24zM64 72c0-4.42 3.58-8 8-8h80c4.42 0 8 3.58 8 8v16c0 4.42-3.58 8-8 8H72c-4.42 0-8-3.58-8-8V72zm0 64c0-4.42 3.58-8 8-8h80c4.42 0 8 3.58 8 8v16c0 4.42-3.58 8-8 8H72c-4.42 0-8-3.58-8-8v-16zm256 304c0 4.42-3.58 8-8 8h-80c-4.42 0-8-3.58-8-8v-16c0-4.42 3.58-8 8-8h80c4.42 0 8 3.58 8 8v16zm0-200v96c0 8.84-7.16 16-16 16H80c-8.84 0-16-7.16-16-16v-96c0-8.84 7.16-16 16-16h224c8.84 0 16 7.16 16 16z"/></svg>

...
<div  class="flex space-x-2 ">
  <div>
    ...
    <div class="offcanvas offcanvas-start fixed bottom-0 flex flex-col max-w-full bg-white invisible bg-clip-padding shadow-sm outline-none transition duration-300 ease-in-out text-gray-700 top-0 left-0 border-none w-80  drop-shadow-2xl  br-2  p-4 " tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
  ...
  <div class="py-4 overflow-y-auto">
      <ul class="space-y-2">
         <li>
            <a href="./index.php" id="nav_dashboard1" class="flex items-center p-2 text-base font-normal rounded-lg text-gray-600">
         ...
         <li>
            <a href="./members.php" id="nav_members1" class="flex items-center p-2 text-base font-normal text-gray-600 rounded-lg hover:bg-emerald-600 hover:text-white">
         ...
         <li>
            <a href="payout.php" id="nav_request1" class="flex items-center p-2 text-base font-normal text-gray-600 rounded-lg hover:bg-emerald-600 hover:text-white">
         ...
         <li>
            <a href="#" id="nav_edit1" class="flex items-center p-2 text-base font-normal text-gray-600 rounded-lg hover:bg-emerald-600 hover:text-white">

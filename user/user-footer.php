...
<nav class="fixed bottom-0 w-full border bg-white flex sm:hidden overflow-x-auto" style="z-index: 1000">
	<a
		href="members.php"
        id="membersFooterA"
		...
		<svg  width="24" height="24"class="flex-shrink-0 w-6 h-6"stroke="currentColor"stroke-width="2" troke-linecap="round" stroke-linejoin="round" fill="none" viewBox="0 0 287.456 287.456" xmlns="http://www.w3.org/2000/svg">
                <g>
                    <g>
                        <g>
                            <g id="XMLID_38_">
